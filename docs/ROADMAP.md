...
CRM core: location get/list/search, contact search/get, conversation search/get/messages, pipeline list/get, opportunity search/get, profile company context, and required location context are started. Remaining Phase 2 work: calendars, guarded messaging, smoke run, audit journal, idempotency, capabilities, fixtures, and doctor commands.
