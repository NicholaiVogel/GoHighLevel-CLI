...
CRM core: location get/list/search, contact search/get, conversation search/get/messages, pipeline list/get, opportunity search/get, profile company context, required location context, and read-only smoke run are started. Remaining Phase 2 work: calendars, guarded messaging, audit journal, idempotency, capabilities, fixtures, and doctor commands.
